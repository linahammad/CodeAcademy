...
for matches in range(1000):
    ...
    print "* Anytime you can press 'Q' for quiting this game."
                ...
                if recharge1 or recharge2:
                        ...
                        if player == 1:
                            ...
                            if search_coor(tmp_x[f], tmp_y[f], ship2):
                                ...
                                if ship_size2[tmp_x] == 1:
                                    ...
                                    if len(ship2[tmp_x]) > 1:
                                        txt += "You damaged my battlecruiser!\n"
                                    else:
                                        if ship_left2 > 1:
                                            txt += "You sunk one of my battlecruiser!\n"
                                        else:
                                            txt = ""
                                            ch2 = ch2[:5] + "Noooo!!!"
                                        ship_left2 -= 1
                                    ...
                                    if len(ship2[tmp_x]) > 1:
                                        txt += "That's my mathership!\n"
                                    else:
                                        if ship_left2 > 1:
                                            txt += "You sunk one of my mathership! Beware of my revenge!!\n"
                                            revenge = True
                                        else:
                                            txt = ""
                                            ch2 = ch2[:5] + "Noooo!!!"
                            ...
                            if search_coor(tmp_x[f], tmp_y[f], ship1):
                                ...
                                if ship_size1[tmp_x] == 1:
                                    if ship_left1 > 1:
                                        txt += "You sunk one of my battleship!\n"
                                    else:
                                        txt = ""
                                        ch1 = ch1[:5] + "Noooo!!!"
                                    ship_left1 -= 1
                    ...
                    if player == 1:
                        if txt == "" and ch2[5:10] != "Noooo":
                            ch2 = ch2[:5] + "That was close!"
                        recharge1 = True        
                        player = 2
                    else:
                        if txt == "" and ch1[5:10] != "Noooo":
                            ch1 = ch1[:5] + "That was close!"
                        recharge2 = True         
                        player = 1
                        round_cnt += 1
            else:
                if player == 1:
                    if recharge1:
                        ...
                        if shockwave2:
                            ...
                            if tmp_coor:
                                ch2 = ch2[:5] + "we've got something on radar!! Near " + tmp_coor
                            else:
                                ch2 = ch2[:5] + "we've got nothing on radar!!"
                        else:
                            ch2 = ch2[:5] + "Fire! Quick!!"
                    elif shockwave1:
                        ch2 = ch2[:5] + "Damn!!"
                        ...
                        if game_board2[guess_row][guess_col] == "X":
                            ch2 = ch2[:5] + "Are you wasting your ammo? Shoot more of that!!"
                            ...
                            if ship_size2[tmp_x] == 1:
                                if ship_left2 > 1:
                                    ch2 = ch2[:5] + "You sunk one of my battleship!"
                                else:
                                    ch2 = ch2[:5] + "Noooo!!!"
                                ship_left2 -= 1
                            elif ship_size2[tmp_x] == 2:
                                if len(ship2[tmp_x]) > 1:
                                    ch2 = ch2[:5] + "You damaged my battlecruiser!"
                                else:
                                    if ship_left2 > 1:
                                        ch2 = ch2[:5] + "You sunk one of my battlecruiser!"
                                    else:
                                        ch2 = ch2[:5] + "Noooo!!!"
                                    ship_left2 -= 1
                            else:
                                if len(ship2[tmp_x]) > 1:
                                    ch2 = ch2[:5] + "That's my mathership!"
                                    cf = True           # change formation when damaged
                                else:
                                    if ship_left2 > 1:
                                        ch2 = ch2[:5] + "You sunk one of my mathership! Beware of my revenge!!"
                                        revenge = True
                                    else:
                                        ch2 = ch2[:5] + "Noooo!!!"
                                    ship_left2 -= 1
                    ...
                    if recharge2:
                        ...
                        if shockwave1:
                            ...
                            if tmp_coor:
                                ch1 = ch1[:5] + "we've got something on radar!! Near " + tmp_coor
                            else:
                                ch1 = ch1[:5] + "we've got nothing on radar!!"
                        else:
                            ch1 = ch1[:5] + "Fire! Quick!!"
                    elif shockwave2:
                        ch1 = ch1[:5] + "Damn!!"
                        ...
                        if game_board1[guess_row][guess_col] == "X":
                            ...
                            if ship_size1[tmp_x] == 1:
                                if ship_left1 > 1:
                                    ch1 = ch1[:5] + "You sunk one of my battleship!"
                                else:
                                    ch1 = ch1[:5] + "Noooo!!!"
                                ship_left1 -= 1
                            elif ship_size1[tmp_x] == 2:
                                if len(ship1[tmp_x]) > 1:
                                    ch1 = ch1[:5] + "You damaged my battlecruiser!"
                                else:
                                    if ship_left1 > 1:
                                        ch1 = ch1[:5] + "You sunk one of my battlecruiser!"
                                    else:
                                        ch1 = ch1[:5] + "Noooo!!!"
                                    ship_left1 -= 1
                            else:
                                if len(ship1[tmp_x]) > 1:
                                    ch1 = ch1[:5] + "That's my mathership!"
                                    cf = True         
                                else:
                                    if ship_left1 > 1:
                                        ch1 = ch1[:5] + "You sunk one of my mathership! Beware of my revenge!!"
                                        revenge = True
                                    else:
                                        ch1 = ch1[:5] + "Noooo!!!"
                                    ship_left1 -= 1
